...
export class TgClient {
    ...
    private constructor(private readonly token: string, private readonly apiEntry = 'https://api.telegram.org') { }
    ...
    public async SendMessage(channelId: number, text: string): Promise<Message> {
        ...
        return (await axios.post<Response<Message>>(this.ConstructRequest('sendMessage'), args)).data.result;
    }
